...
public class JwtUtils {
    ...
    @Value("${SECRET_KEY:myDefaultSecretKey}") // Ensures a default value
    private String jwtSecret;
    ...
    @PostConstruct
    public void init() {
        System.out.println("JWT Secret Key Loaded: " + jwtSecret);
    }
    ...
    public String generateJwtToken(Authentication authentication) {
        ...
        String token = Jwts.builder()
            ...
            .signWith(SignatureAlgorithm.HS512, jwtSecret.getBytes()) // Convert secret key to bytes
            .compact();
